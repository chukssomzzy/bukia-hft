describe("IdempotentServices", () => {
  describe("getStatus", () => {
    ...
    it.todo(
      "returns correct completed/progress/response when record exists with processing/completed/failed",
    );
  });
  ...
  describe("streamStatus", () => {
    ...
    it.todo(
      "stops emitting and ends response when status.completed becomes true",
    );
